...
execute if entity @s[tag=B.North,tag=B.South] unless block ~ ~-1 ~-1 air if block ~ ~-1 ~1 air if block ~ ~1 ~ air run scoreboard players add @s fg.update 1
#---------------------------Grow---------------------------#
execute if score @s fg.update matches 16.. if block ~ ~1 ~ air run setblock ~ ~ ~ chorus_plant
execute if score @s fg.update matches 16.. if block ~ ~1 ~ air run setblock ~ ~1 ~ chorus_flower
