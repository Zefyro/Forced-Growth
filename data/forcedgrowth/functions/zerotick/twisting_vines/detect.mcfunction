...
#---------------------------AECs---------------------------#
execute unless entity @e[type=marker,tag=Forced-Growth,tag=!Forced-Growth-Setup,distance=..0.1] run execute if entity @s[tag=P.East,tag=P.West,tag=!P.North,tag=!P.South,tag=Forced-Growth-Setup] run summon marker ~ ~ ~ {Tags:["Zerotick","Forced-Growth"],CustomName:'{"text":"twisting_vines"}'}
execute unless entity @e[type=marker,tag=Forced-Growth,tag=!Forced-Growth-Setup,distance=..0.1] run execute if entity @s[tag=P.North,tag=P.South,tag=!P.East,tag=!P.West,tag=Forced-Growth-Setup] run summon marker ~ ~ ~ {Tags:["Zerotick","Forced-Growth"],CustomName:'{"text":"twisting_vines"}'}
