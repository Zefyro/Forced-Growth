...
tellraw @s [{"text":"\n  Video by EagleEye621: ","color": "gray"},{"text":"[YouTube]","color": "white","clickEvent": {"action": "open_url", "value": "https://www.youtube.com/watch?v=dnetydjmPbY&t"},"hoverEvent": {"action": "show_text", "value": "Open on YouTube."}}]
