...
# Block detection
execute if block ~-1 ~-1 ~ air unless block ~1 ~-1 ~ air if block ~ ~1 ~ water run tag @s add block+x
execute if block ~1 ~-1 ~ air unless block ~-1 ~-1 ~ air if block ~ ~1 ~ water run tag @s add block-x
execute if block ~ ~-1 ~-1 air unless block ~ ~-1 ~1 air if block ~ ~1 ~ water run tag @s add block+z
execute if block ~ ~-1 ~1 air unless block ~ ~-1 ~-1 air if block ~ ~1 ~ water run tag @s add block-z
...
# RNG
execute if score @s fg.zef_math matches 2 store success score @s fg.zef_rng run execute if predicate fg_zef:kelp_growth_chance

# Grow
execute if score @s fg.zef_update matches 1 if block ~ ~1 ~ water if score @s fg.zef_rng matches 1 run setblock ~ ~1 ~ kelp
