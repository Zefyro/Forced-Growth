...
execute if entity @s[tag=negative_x,tag=positive_x] unless entity @e[type=area_effect_cloud,tag=forced_growth,distance=...3] run summon minecraft:area_effect_cloud ~ ~ ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["forced_growth"],CustomName:'{"text":"twistingvines"}'}

execute if entity @s[tag=negative_z,tag=positive_z] unless entity @e[type=area_effect_cloud,tag=forced_growth,distance=...3] run summon minecraft:area_effect_cloud ~ ~ ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["forced_growth"],CustomName:'{"text":"twistingvines"}'}
