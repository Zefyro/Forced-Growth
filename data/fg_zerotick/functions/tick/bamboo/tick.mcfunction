...
# RNG
execute if score @s fg.zef_math matches 2 store success score @s fg.zef_rng run execute if predicate fg_zef:bamboo_growth_chance

# Grow
execute if score @s fg.zef_update matches 1 if block ~ ~1 ~ air if score @s fg.zef_rng matches 1 run setblock ~ ~1 ~ bamboo[leaves=small]
